	...
	<c:choose>
		...
		<c:when test="${not empty cartLines}">
			...
			<table id="cart" class="table table-hover table-condensed">
				...
				<tbody>
					...
					<c:forEach items="${cartLines}" var="cartLine">
						...
						<tr>
							...
							<td data-th="Subtotal" class="text-center">Rp ${cartLine.total }</td>
				...
				<tfoot>
					<tr class="visible-xs">
						<td class="text-center"><strong>Total Rp ${userModel.cart.grantTotal}</strong></td>
					</tr>
					<tr>
						...
						<td class="hidden-xs text-center"><strong>Total
								Rp ${userModel.cart.grantTotal}</strong></td>
